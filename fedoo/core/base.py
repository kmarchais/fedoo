...
try:
    ...
    try:
        ...
        print(
            "WARNING: no fast direct sparse solver has been found. Consider installing pypardiso or scikit-umfpack to improve computation performance",
        )
        USE_UMFPACK = False
...
class ProblemBase:
    ...
    def set_active(name):
        ...
        if isinstance(name, ProblemBase):
            ...
            raise NameError(f"{name} is not a valid Problem.")
