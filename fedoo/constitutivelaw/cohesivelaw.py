...
from fedoo.core.base import AssemblyBase, ConstitutiveLaw
...
class CohesiveLaw(Spring):
    ...
    def update_irreversible_damage(self, assembly):
        if assembly.sv["DamageVariable"] == 0:
    ...
    def _update_damage(self, assembly, delta):
        ...
        if assembly.sv["DamageVariableOpening"] == 0:
        ...
        if assembly.sv["DamageVariableIrreversible"] == 0:
            ...
            assembly.sv["DamageVariable"] = np.max(
                [assembly.sv["DamageVariableIrreversible"], d],
                axis=0,
            )
