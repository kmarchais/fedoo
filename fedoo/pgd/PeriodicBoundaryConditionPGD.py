...
def DefinePeriodicBoundaryCondition(
    ...
    if dim == 2:
        ...
        mesh.add_node_set(
            [np.full_like(right, NodeEps[0])],
            [numGeometricMesh],
            name="EpsXX_right",
        )
        mesh.add_node_set(
            [np.full_like(right, NodeEps[2])],
            [numGeometricMesh],
            name="EpsXY_right",
        )
        mesh.add_node_set(
            [np.full_like(top, NodeEps[2])],
            [numGeometricMesh],
            name="EpsXY_top",
        )
        mesh.add_node_set(
            [np.full_like(top, NodeEps[1])],
            [numGeometricMesh],
            name="EpsYY_top",
        )
        mesh.add_node_set(
        ...
        mesh.add_node_set(
            [np.full_like(right, NodeEps[3])],
            [numGeometricMesh],
            name="EpsXY_right",
        )
        mesh.add_node_set(
            [np.full_like(right, NodeEps[4])],
            [numGeometricMesh],
            name="EpsXZ_right",
        )
        mesh.add_node_set(
            [np.full_like(top, NodeEps[3])],
            [numGeometricMesh],
            name="EpsXY_top",
        )
        mesh.add_node_set(
        ...
        mesh.add_node_set(
            [np.full_like(top, NodeEps[5])],
            [numGeometricMesh],
            name="EpsYZ_top",
        )
        mesh.add_node_set(
            [np.full_like(front, NodeEps[4])],
            [numGeometricMesh],
            name="EpsXZ_front",
        )
        mesh.add_node_set(
            [np.full_like(front, NodeEps[5])],
            [numGeometricMesh],
            name="EpsYZ_front",
        )
        mesh.add_node_set(
            [np.full_like(front, NodeEps[2])],
            [numGeometricMesh],
            name="EpsZZ_front",
        )
